...
def migrate_hardcode_postgres_data_and_password(
    ...
    pair = {
        "/var/lib/llmfabric/postgres/data": os.path.join(
            cfg.postgres_base_dir(), "data"
        ),
        "/var/lib/llmfabric/postgres_root_pass": os.path.join(
            cfg.data_dir, "postgres_root_pass"
        ),
        "/var/lib/llmfabric/run/migration_done": get_migration_done_file(cfg),
    }
